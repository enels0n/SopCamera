...
public class Renderer extends MapRenderer {
	...
	public void render(MapView map, MapCanvas canvas, Player player) {
		...
		boolean transparentWater = SopCamera.getInstance().getConfig().getBoolean("camera.transparentWater");
		boolean shadows = SopCamera.getInstance().getConfig().getBoolean("camera.shadows");
		...
		Bukkit.getScheduler().runTaskAsynchronously(SopCamera.getInstance(),
