...
public class Utils {
	...
	public static ItemStack createCamera() {
		...
		tag.a("SopCamera-durability", durability);
		tag.a("SopCamera-maxdurability", durability);
		stack.c(tag);
	...
	public static int getDurability(ItemStack item) {
		...
		if (tag.e("SopCamera-durability")) {
			return tag.h("SopCamera-durability");
		}
	...
	public static ItemStack setParams(ItemStack item, int durability) {
		...
		if(durability > 0)
			tag.a("SopCamera-durability", durability);
		durability = tag.h("SopCamera-durability");
		...
		int itemDurability = (int)((((double)durability)/maxDurability)*itemMaxDurability);
